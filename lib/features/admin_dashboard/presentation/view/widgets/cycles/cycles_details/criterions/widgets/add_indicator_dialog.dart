...
import 'package:qualiverse_system/core/shared_widgets/custom_dialog.dart';
import 'package:qualiverse_system/features/admin_dashboard/presentation/view/widgets/cycles/cycles_details/courses/widgets/create_course_dialog_widgets.dart'
    hide buildFormField;
import 'package:qualiverse_system/routing/all_routes_imports.dart';
import 'package:easy_localization/easy_localization.dart';

void showAddIndicatorDialog(
  BuildContext context,
  CriterionItemModel criterion,
) {
  showDialog(
    context: context,
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildReadonlyInfo(
              'accreditationType'.tr(),
              widget.criterion.accreditation,
            ),
            _buildReadonlyInfo(
              'department'.tr(),
              widget.criterion.department.isEmpty
                  ? '--'
