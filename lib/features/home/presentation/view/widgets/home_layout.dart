  ...
  static Widget buildDesktopLayout(
    ...
    return Row(
      children: [
        ...
        Expanded(
          flex: 3,
          child: HomeAnimation.buildTextContent(isArabic, false, context),
        ),
        SizedBox(width: isTablet ? 24.w : 48.w),
        Expanded(flex: 2, child: HomeAnimation.buildMainImage()),
      ],
    );
  }
  ...
  static Widget buildMobileLayout(
    ...
    return Column(
      ...
      children: [
        ...
        HomeAnimation.buildTextContent(isArabic, true, context),
        SizedBox(height: 24.h),
