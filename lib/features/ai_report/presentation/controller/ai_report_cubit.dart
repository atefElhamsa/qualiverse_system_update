...
import 'package:qualiverse_system/features/ai_report/data/models/improvement_plan_form_model.dart';
import 'package:qualiverse_system/features/ai_report/data/service/ai_report_service.dart';
import 'package:qualiverse_system/features/ai_report/data/models/instructor_form_model.dart';
import 'package:qualiverse_system/features/ai_report/presentation/controller/ai_report_controllers_mixin.dart';
...
class AiReportCubit extends Cubit<AiReportState> with AiReportControllersMixin {
  ...
  Future<void> submitReport() async {
    ...
    try {
      ...
      final responseBody = await AiReportService.submitReport(
        aiRequestId,
        requestData,
      );
