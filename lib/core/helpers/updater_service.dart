...
class UpdaterService {
  static String get _versionUrl =>
      'https://raw.githubusercontent.com/atefElhamsa/qualiverse_system_update/main/version.json?t=${DateTime.now().millisecondsSinceEpoch}';
...
class _UpdateDialogWidgetState extends State<_UpdateDialogWidget>
  ...
  Future<void> _startDownloadAndInstall() async {
    ...
    try {
      final exeUrl =
          'https://github.com/atefElhamsa/qualiverse_system_update/releases/download/v${widget.latestVersion}/qualiverse_system_setup.exe';

      final tempDir = await getTemporaryDirectory();
      final savePath =
          '${tempDir.path}\\qualiverse_system_setup_v${widget.latestVersion}.exe';
