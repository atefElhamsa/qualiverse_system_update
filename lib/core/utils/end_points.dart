class EndPoints {
  static const String baseUrl = "https://qualiverse-test.runasp.net/api/";
  static const String baseUrlToOpenFile =
      "https://qualiverse_system.runasp.net";
  ...
  static String aiReportPublish(int aiRequestId) =>
      "AIReports/$aiRequestId/publish";
