...
import 'package:qualiverse_system/core/utils/app_colors.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (messageText == "widthTooSmallMessage") {
      messageText = isArabic
          ? "يتطلب qualiverse_system عرض شاشة أكبر لعرض المحتوى بشكل صحيح. يرجى تكبير النافذة أو زيادة عرضها لمتابعة استخدام التطبيق."
          : "qualiverse_system requires a larger screen width to display content correctly. Please resize your window or maximize it to continue using the application.";
    }
